...
const Dislike = {
    active:(
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#23578984" className="w-full h-full">
...
const Like = {
    active: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3FB7F8FF" className="w-full h-full">
...
const Heart = {
    active: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#EE2323FF" className="w-full h-full">
...
const MadIcon = {
    active: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#AD0000E5" className="w-full h-full">
...
export {
    ...
    SettingIcon, Logout,
    EuroIcon, ProfilePic, SearchbarIcon, FollowIcon, DontFollow,
    DenyIcon, CheckIcon, SubmitIcon,
    CommentIcon, CopyIcon, ArrowRightIcon, NotificationIcon
};
