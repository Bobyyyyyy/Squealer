...
export default function RootLayout() {
    const navigationButtons = [
        ...
        {id: 2,
            ...
            </svg>), name: "add post", route: "addpost"},
    ...
    console.log("home inactive e active");
    console.log(HomeIcon.inactive);
    console.log(HomeIcon.active);
                        ...
                        {navigationButtons.map( (item) => (
                            ...
                            >
                                {({isActive}) => {
                                    ...
                                    return (isActive) ? item.svgActive : item.svgInactive;
                                }}
                            </NavLink>
                        ))}
                    </div>
