...
function DeleteChannelModal({isOpen, setIsOpen, channelName}) {
    ...
    return (
        <Modal show={isOpen} onClose={() => setIsOpen(false)}>
            <Modal.Header aria-label="Eliminazione Canale">Eliminazione Canale</Modal.Header>
            <Modal.Body>
                <div className="flex flex-col gap-6 w-full">
                    <div className="flex flex-col w-full justify-center gap-0.5 items-center overflow-x-hidden">
                        <p className="text-center font-bold text-xl" id="deleteChannelConfirmation">
                            Sei sicuro di eliminare il canale
                        </p>
                        <div className="flex gap-2">
                            <span className="font-extrabold text-2xl" aria-labelledby="deleteChannelConfirmation">
                                {channelName}
                            </span>
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-1 text-center text-lg">
                        <span>Una volta fatto</span>
                        <span className="uppercase font-bold">
                            non
                        </span>
                        <span>sarà possibile ripristinare il canale</span>
                    </div>
                </div>
            </Modal.Body>
            <Modal.Footer>
                <button
                    ...
                    aria-label="Conferma eliminazione canale"
                >
                    CONFERMO
                </button>
            </Modal.Footer>
