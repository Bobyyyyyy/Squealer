...
<template>
  <div class="d-flex flex-row justify-content-around align-items-center text-dark ">
    <div class="d-flex flex-row align-items-center sameWidth justify-content-center ">
    ...
    <div class="d-flex align-items-center sameWidth justify-content-center">
    ...
    <div class="d-flex sameWidth justify-content-center">
